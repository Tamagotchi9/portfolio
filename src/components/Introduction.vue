<template>
  <header
    class="lg:w-1/2 static lg:sticky lg:top-0 lg:max-h-screen flex flex-col justify-between lg:py-24"
  >
    <div>
      <div class="flex flex-col items-center lg:flex-row lg:items-start">
        <div class="rounded-full w-24 h-24 border-slate-200 border-2 mr-4">
          <img class="rounded-full w-full h-auto" :src="HeroThumbnail" alt="me" />
        </div>
        <div>
